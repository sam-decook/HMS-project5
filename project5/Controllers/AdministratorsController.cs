...
namespace project5.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public AdministratorsController(project5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Administrator administrator)
        {
